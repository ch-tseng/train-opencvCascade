...
#-----------------------------------------------
cascadeFile = "cascadeXML/body_LBA_48.xml"
useDP = True
...
videoPath = "mp4/misoffice_2x.mp4"
min_size = (90, 90)
max_size = (240, 240)
monitor_winSize = (640, 640)
savePath = "rois"
modelJSON = "model/body_model.json"
modelWeight = "model/body_model.h5"
...
if(useDP==True):
    dp = dpModel(modelJSON, modelWeight)
            ...
            if( (w>min_size[0] and h>min_size[1]) and (w<max_size[0] and h<max_size[1]) ):
                ...
                if(useDP == True):
                    ...
                    if(predictROI==True):
                        ...
                        i += 1
                        #print("True")
                        putText(img, "True", x+5, y+20, color=(0,255,0), thickness=2, size=0.6)
                        if(writeIMG==True):
