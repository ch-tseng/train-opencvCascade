...
xmlFolder = "datasets/palm/v3/labels"
imgFolder = "datasets/palm/v3/images"
labelName = "palm"

#All files and setting will save to the project folder
folderPROJECT = "handGesture"

makeROI_dataset = True
roiSaveToFolder = "palms"  #If empty, the roi image from the labels will not be saved.
roiSaveType = "jpg"
roiResize = (64,64)
